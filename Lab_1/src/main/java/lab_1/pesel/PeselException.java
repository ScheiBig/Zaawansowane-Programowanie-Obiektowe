 ...
 */
public class PeselException extends IllegalArgumentException {

	private PeselException(String s) {
		super(s);
	}

	public static class NullException extends PeselException {
	...
	public static class ControlSumException
			extends PeselException {
		public ControlSumException(int expected, int actual) {
